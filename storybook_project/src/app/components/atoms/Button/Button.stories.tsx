...
const Template: CSF2Story<ButtonProps> = (args: React.JSX.IntrinsicAttributes & ButtonProps) => <Button {...args} />;
...
export const CSF2StoryWithLocale: CSF2Story = (_args, { globals: { locale } }) => {
...
export const WithActionArg: CSF3Story<{ someActionArg: HandlerFunction }> = {
  ...
  render: (args: { someActionArg: (arg0: string) => void; }) => {
